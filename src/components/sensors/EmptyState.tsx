...
const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4 rounded-lg border border-border dark:border-border-dark bg-card dark:bg-card-dark shadow-sm dark:shadow-md">
      ...
      <h3 className="mt-2 text-base font-medium text-textPrimary dark:text-textPrimary-dark text-center">
        {message}
      </h3>
      <p className="mt-2 text-sm text-textMuted dark:text-textMuted-dark max-w-xs text-center">
        {description}
      </p>
