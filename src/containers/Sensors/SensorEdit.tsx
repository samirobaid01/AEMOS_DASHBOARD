...
const SensorEdit = () => {
  ...
  const [formData, setFormData] = useState<SensorUpdateRequest>({
    name: '',
    type: '',
    status: true,
    description: '',
  ...
  useEffect(() => {
    if (sensor) {
      ...
      // Convert metadata object to array for form fields
      const metadataArray = Object.entries(sensor.metadata || {}).map(
